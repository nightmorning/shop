...
<div style="width: 1170px;margin: 0 auto;margin-top:14px;">
    ...
    <style>
        ...
        #cDetails td textarea {
            height: 80px;
            width: 300px;
            resize: none;
        }

        #cDetails td:first-child{
            text-align: right;
            padding-right: 12px;
        }
    ...
    <div id="cDetails" style="width:600px;">

        <table>
            <tbody>
            <tr>
                <td >网站标题</td>
                <td><input type="text" name="title" class="k-textbox" value="<?php echo ($config["title"]); ?>"/></td>
            </tr>

            <tr>
                <td>关键词</td>
                <td><textarea resize="0" type="text" name="keywords" class="k-textbox" ><?php echo ($config["keywords"]); ?></textarea></td>
            </tr>

            <tr>
                <td>描述</td>
                <td><textarea type="text" name="description" class="k-textbox" ><?php echo ($config["description"]); ?></textarea></td>
            </tr>
    ...
    <script>
        var moduleName = "WebsiteConfig";

        var allowedUpdate = false;

        $("#cDetails input,textarea").change(function(){
            allowedUpdate = true;
        });
    </script>
