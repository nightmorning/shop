...
<div style="width: 1170px;margin: 0 auto;overflow: hidden">
    ...
    <div style="margin-top: 10px;margin-bottom: 30px">
        ...
        <div class="details-top-right row">
            ...
            <div class="col-md-12">租金：<span style="color: #ff0000">600</span>元</div>
            <div class="col-md-5">押金：<span style="color: #ff0000">2000</span>元</div>
            <div class="col-md-7">交易方式:租主包送</div>
            <div class="col-md-5">起租：3个月</div>
            <div class="col-md-7">归还方式：租客包送</div>
            <div class="col-md-12">地址：深圳市罗湖区星光大道888号</div>
            ...
            <div class="col-md-12" style="margin-bottom: 20px;">数量：</div>
            <div class="col-md-5"><a target="_blank"
                                     href="http://wpa.qq.com/msgrd?v=3&uin=792526287&site=qq&menu=yes"><input
    ...
    <script>
        ...
        $("#dpend").datetimepicker({
            format: "yyyy-mm-dd",
            startDate: myDate.getDate() + 1000 * 60 * 60 * 24,
            autoclose: true,
            todayBtn: true,
            pickerPosition: "bottom-left",
            minView: 2,
        ...
        $("#submit").click(function(){
            ...
            $.get('UserObject',{}, function (retObj) {
