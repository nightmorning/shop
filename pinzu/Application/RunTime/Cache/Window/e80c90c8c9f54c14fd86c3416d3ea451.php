...
<head lang="zh-cn">
    ...
    <style type="text/css">
        .login-position{width: 560px;height:385px;margin: 0 auto;padding-top:20px;color:#ffffff;background-image:url(/Source/images/loginArea.png);background-repeat: no-repeat; }
    </style>
