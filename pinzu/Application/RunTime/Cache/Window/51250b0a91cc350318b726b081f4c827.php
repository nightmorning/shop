...
<div style="width: 1170px;margin: 0 auto;overflow: hidden">
    ...
    <div class="row" style="line-height:35px;border:1px solid #f90;margin: 1px;margin-top: 20px;">
        <div class="col-md-12"><h4><b>手机苹果</b></h4></div>
        <div class="col-md-12"><buttton type="button" class="btn btn-danger btn-xs" onclick="satisfy('<?php echo ($item["id"]); ?>')">满足</buttton></div>
        <div class="col-md-9">
        ...
        <div class="col-md-3" style="line-height:25px;border: 1px solid #f90;margin-bottom: 20px;margin-right: 5px;width: 24%;">
            <div class="col-md-12"><p><b>求租着信息</b></p></div>
            <div class="col-md-4 menber-image"></div>
            <div class="col-md-8">
                <div class="col-md-12">会员名：XXXXX</div>
                <div class="col-md-12">积  分：200</div>
                <div class="col-md-12">信用值：20</div>
            </div>
            <div class="col-md-12">联系人：李经理</div>
            <div class="col-md-12">电话：<span style="color: #ff0000"><b>13000000000</b></span></div>
            <div class="col-md-12">会员类型：<span>VIP</span></div>
            <div class="col-md-12">认证：手机认证&nbsp;邮箱认证</div>
