...
<div class="col-md-2" style="width:150px;">
    <ul class="nav nav-list">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" style="margin: 5px 0" placeholder="输入兑换码"/>
            <button type="submit" style="margin: 5px 0" class="btn btn-warning">立即兑换
        </button>
            ...
            <table id="cMain" class="table table-bordered">
                ...
                <tbody>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr class="success">
                        <td><?php echo ($item["id"]); ?></td>
                        <td><?php echo (intval($item["param_1"])); ?>元代金券</td>
                        <td><?php echo (substr($item["expiry_date_start"],0,10)); ?>至<?php echo (substr($item["expiry_date_end"],0,10)); ?></td>
